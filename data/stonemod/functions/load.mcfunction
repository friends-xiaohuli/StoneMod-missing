...
tellraw @a [{"text":"点击","color":"aqua"},{"text":"[玩法帮助]","color":"aqua","bold":true,"clickEvent":{"action":"run_command","value":"/function stonemod:bz"}},{"text":"查看详情，获取帮助设置书","color":"aqua"}]
tellraw @a [{"text":"版本:V2合并版！","color":"red"}]
...
scoreboard players set §a当前版本：V2.3.1 stonetime -1
