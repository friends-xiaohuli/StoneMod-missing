...
scoreboard players set {"text":"当前版本：V2.0重制版-D","color":"aqua","bold":true} stonetime -1
scoreboard players set {"text":"By霜澪是只白狐ya、Big_Jls","color":"yellow","bold":true} stonetime -2
